...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>src/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
  <link rel="stylesheet" href="<?php echo base_url();?>src/plugins/toastr/toastr.min.css">
...
<script src="<?php echo base_url();?>src/plugins/sweetalert2/sweetalert2.min.js"></script>
<script src="<?php echo base_url();?>src/plugins/toastr/toastr.min.js"></script>


<?php include('application/views/admin/include/plugins_scripts.php');?>
<?php include('application/views/admin/include/implementaciones.php'); ?>
</body>
</html>
